...
typedef struct _CanonicalTable
{
  DWORD dwCodepoint;
  DWORD dwClass;
};
typedef struct _CanonicalTable CanonicalTable;
...
typedef struct _DecomposeTable
{
  DWORD dwCodepoint;
  short length;
  DWORD dwzData[20];
};
typedef struct _DecomposeTable DecomposeTable;
...
typedef struct _ComposeTable ComposeTable;
